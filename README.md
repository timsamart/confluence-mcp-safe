...
The generated MCP environment includes `CONFLUENCE_EMAIL` only for Cloud (or when that variable is explicitly set). Data Center installations do not receive the Cloud-only placeholder.
